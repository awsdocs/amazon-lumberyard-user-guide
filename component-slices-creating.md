...
![\[Choose Yes in the Cannot Create Slice dialog box to create a root entity while creating the slice.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/cannot-create-slice-create-root-entity.png)
