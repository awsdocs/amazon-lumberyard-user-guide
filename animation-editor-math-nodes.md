...
![\[Example of the Rotation Math 2 node in an animation graph.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/rotation-math.png)
...
![\[Figure of Rin in the Animation Editor with a rotated foot.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/rotation-limit-figure.png)
...
![\[Example of the Rotation Limit node in an animation graph.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/rotation-limit-graph.png)
...
![\[Rotation Limit attributes panel.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/rotation-limit-properties.png)
...
![\[Example of the Vector Decompose nodes in an animation graph.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/vector-decompose.png)
...
![\[Example of a Boolean Logic node in an animation graph.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/boolean-logic-node.png)

### Boolean Logic Node Attributes<a name="boolean-logic-node-attributes"></a>

![\[Boolean Logic node attributes pane.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/boolean-logic-node-attributes.png)
...
![\[Example of the Boolean Logic nodes in an animation graph.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/boolean-logic-node-attributes-1.png)