...
![\[The example game scene.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-1.png)
...
![\[The components for the robot entity.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-robot-components.png)
...
![\[The components for the gun entity in Entity Inspector.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-gun-components.png)
...
![\[Example motion set.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-2.png)
...
![\[Motion node with associated animation.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-3.png)
...
![\[Motion node with associated idle motion.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-4.png)  
![\[Motion node with associated animation.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-5.png)
...
![\[Choose Add parameter in Animation Editor.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-6.png)
...
![\[Choose a value type for the parameter.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-7.png)

1. For **Name**, enter a name for the parameter\. This example uses `gunTrigger`\.  
![\[Enter a parameter name.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-8.png)

1. Click **Create**\. The **Parameters** list shows the parameter that you created\.  
![\[Parameter added to the animation graph.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-9.png)
...
![\[Select the transition line to add a parameter condition.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-10.png)

1. Click **Select parameter**\.  
![\[Click Select parameter.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-11.png)

1. In the **Parameter Selection Window**, choose the parameter that you just created, and click **OK**\.  
![\[Choose a parameter for the parameter condition.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-12.png)
...
![\[Small round node indicating a parameter condition.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-13.png)
...
![\[Specifying a test function for the parameter condition.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-14.png)
...
![\[Select the opposite transition line to add another parameter condition.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-15.png)
...
![\[Adding a parameter to the primary graph.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-16.png)

1. In the **Create Parameter** dialog box, for **Value type**, choose the data type that you want to use for the parameter\. This example uses the **Boolean \(checkbox\)** value type because the gun trigger is either on or off\.  
![\[Choosing a value type for the parameter.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-17.png)

1. For **Name**, enter a name for the parameter\. This example uses `shoot`\.  
![\[Enter a name for the parameter for the primary graph.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-18.png)
...
![\[Click the transition line to add a parameter condition.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-19.png)

1. Click **Select parameter**\.

1. In the **Parameter Selection Window**, choose the parameter that you just created\. This example uses `shoot`\.  
![\[Choose a parameter for the parameter condition.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-20.png)
...
![\[Add a parameter condition to the other transition line.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-21.png)
...
![\[Click the transition line to add a servant parameter action.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-22.png)

1. In the **Attributes** pane for the primary graph, click **Add action**, **Servant Parameter Action**\.  
![\[Click Add action, Servant Parameter Action.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-23.png)
...
![\[Use On Enter for Trigger Mode.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-24.png)
...
![\[Click Select parameter.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-25.png)  
![\[Choose a parameter for the servant parameter action.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-12.png)
...
![\[Small square node indicating a parameter action.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-26.png)
...
![\[Specify a trigger value.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-27.png)
...
![\[Sample input bindings asset for sync control in the Input Bindings Editor.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-28.png)
...
![\[Sample input bindings asset for shoot control in the Input Bindings Editor.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-29.png)
...
![\[Sync mode off\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-example-sync-off.gif)

The following animated image shows the example when the sync mode is turned on\. The gun fires when the robot fires\.

![\[Sync mode on\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/char-animation-editor-sync-graph-example-sync-on.gif)