...
![\[Enable the Gestures gem to detect common gesture input actions.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/gestures-gem.png)

To enable the Gestures gem for your project, see [Using Gems to Add Modular Features and Assets](gems-system-gems.md)\.
...
![\[Use the System Entity Editor to manage the gesture settings.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/gestures-system-entity-editor-settings.png)
**Note**  
