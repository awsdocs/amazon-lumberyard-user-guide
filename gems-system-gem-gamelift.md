...
![\[GameLift client-server communication workflow using fleet or queues to create a game session.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/game-lift-gem-workflow.png)

 **GameLift client\-server communication workflow using FlexMatch, with automatic or custom backfill\.**

![\[GameLift client-server communication workflow using FlexMatch, with automatic or custom backfill.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/game-lift-gem-workflow-matchmaking.png)
