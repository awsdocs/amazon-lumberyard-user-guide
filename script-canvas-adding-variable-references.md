...
![\[Create a variable reference by dragging a variable from Variable Manager onto a Script Canvas node's data pin.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/script-canvas-variable-reference-create.gif)
...
![\[Change the variable in a variable reference by choosing the gear button next to the variable name on the data pin and selecting a different variable from the list.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/script-canvas-variable-reference-change.png)

**To convert a variable reference back to a value or into a variable node**

1. Right\-click on the data pin that you want to convert\.

1. Do one of the following:
   + Choose **Convert to Value** to restore that data pin as a value\.
   + Choose **Convert to Variable Node** to create a **Get** variable node from a data input pin, or a **Set** variable node from a data output pin\.  
![\[Convert a variable reference back to a value or to a variable node by right-clicking on the data pin and choosing from the Convert options.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/script-canvas-variable-reference-convert-back.gif)

**To convert a data pin into a variable reference**

1. Right\-click on the data pin and choose **Convert to Reference**\.  
![\[Convert a data pin to use a variable reference by right-clicking on the pin and choosing Convert to Reference.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/script-canvas-variable-reference-convert-pin.png)
...
![\[Convert a variable node into a variable reference on a data pin by right-clicking on the variable node and choosing Convert to References.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/script-canvas-variable-reference-convert-variable-node.gif)