...
![\[River on the ground before carving a riverbed.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/carving-riverbed-1.png)
A river with a **Border width** of `5.0`, **Embankment** of `1.0`, **Depth** of `2.0`, and **River bed offset** of `-1`\.  

![\[Example river with a smaller embankment and border width.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/carving-riverbed-2.png)
A river with a **Border width** of `10.0`, **Embankment** of `3.0`, **Depth** of `2.0`, and **River bed offset** of `-1`\.  

![\[Example river with a larger border width and embankment.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/carving-riverbed-3.png)
...
![\[Example river that is below ground level.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/carving-riverbed-4.png)
...
![\[River with one vertex widened\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/modifying-river-width-2.png)
...
![\[WaterVolume Shader parameters\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/setting-river-materials-1.png)
