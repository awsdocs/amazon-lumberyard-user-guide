...
![\[Drag a variable from the Script Canvas Variable Manager to the canvas to create an on-value-changed node.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/variable-manager-create-on-value-changed.gif)
...
![\[Set the Source field of an OnVariableValueChanged event node using the field's gear button.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/variable-manager-create-on-value-changed-node.png)
