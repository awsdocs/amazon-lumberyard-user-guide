...
The Rain Gem creates realistic rain effects in your levels, including rain drops, puddles, mist, wet surfaces, and splashes\. To enable the Rain Gem in your project, see [Using Gems to Add Modular Features and Assets](gems-system-gems.md)\.

This gem is a game object extension\. On initialization, it preloads all textures listed in the `raintextures.xml` file\.

![\[Image NOT FOUND\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/gems-system-gem-rain.png)
