...
**To add a Shadows Setup node in the **Track View** editor**

1. In the ****Track View** editor**, right\-click the sequence \(top node\) or the **Director** node in the tree, and then choose **Add Shadows Setup Node**\.
