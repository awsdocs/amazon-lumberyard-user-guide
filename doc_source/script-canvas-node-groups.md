...
![\[Click the Group Color icon in the Script Canvas Node Inspector to customize the color of a node group.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/script-canvas-node-groups-2.png)
...
![\[Choose or create a color for a group node in the Script Canvas editor.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/script-canvas-node-groups-3.png)
...
![\[Expand a node group's Font Settings section in the Script Canvas Node Inspector.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/script-canvas-node-groups-4.png)  
****    
