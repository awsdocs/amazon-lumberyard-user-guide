...
![\[The Blend N node properties.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/animation-editor-blending-blendn.png)
...
![\[On the Anim Graph Palette tab, select the Blending tab, and then drag Blend N into the animation graph.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/animation-editor-blending-blendn-select.png)
...
![\[Blend N node on the animation graph with inputs and outputs exposed.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/animation-editor-blending-blendn-inoutputs.png)
...
![\[Example of ascending order for Max weight trigger values.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/animation-editor-blending-blendn-example.png)

If you enter a series of values in an invalid order, the value box turns red and displays a warning\.

![\[Example of ascending order for Max weight trigger values.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/animation-editor-blending-blendn-error.png)
