...
![\[Click Install to install RC Shell Commands in Lumberyard Setup Assistant\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/asset-pipeline-images-resourcecompiler-1.png)
...
![\[In the Resource Compiler image tool, select a preset and then click Generate Output to generate the .exportsettings file to check in.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/asset-pipeline-images-resourcecompiler.jpg)