...
[Enable](gems-system-using-project-configurator.md) the Asset Validation gem in your game project, and then [build](building-your-lumberyard-game-project.md) your game project\.
