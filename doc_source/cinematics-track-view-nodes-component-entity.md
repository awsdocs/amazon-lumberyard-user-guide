...
When you add an animation using the **Track View** editor, the animation track is applied to a component node\. Component entity nodes don't directly have tracks or key properties\. 
...
When you add a component to a component entity in Lumberyard Editor, the component is automatically added to any component entity nodes in the **Track View** editor\. When you remove a component, the component and any animation data are also removed from the **Track View** editor\. 
