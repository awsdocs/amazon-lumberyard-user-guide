...
![\[The Scene Processing gem enables Lumberyard to process scene files such for your game.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/gem-system-gem-sceneprocessing.png)

**Note**  
The Scene Processing gem is required and enabled by default for Lumberyard projects\.

For information about working with file types and settings, see [FBX Soft Naming Conventions](char-fbx-importer-soft-naming.md)\.