...
The Snow Gem creates realistic snow effects in your levels, including snowflake and surface effects, such as snow buildup\. To enable the Snow Gem in your project, see [Using Gems to Add Modular Features and Assets](gems-system-gems.md)\.

**Note**  
Place only a single **Snow** entity in your scene\.

![\[Image NOT FOUND\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/gems-system-gem-snow.png)
