...
![\[Choose a cloud gem from the Cloud Gems page to view log information.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/cloud-canvas-cloud-gem-portal-log-tab-1.png)
...
![\[The Log tab in the Cloud Gem Portal.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/cloud-canvas-cloud-gem-portal-log-tab-2.png)
...
![\[Open the CloudWatch Logs console from the Cloud Gem Portal.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/cloud-canvas-cloud-gem-portal-log-tab-3.png)
...
![\[View the log group information in the CloudWatch Logs console.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/cloud-canvas-cloud-gem-portal-log-tab-4.png)
...
![\[Click a log stream in the Cloud Gem Portal to view the information in the CloudWatch Logs console.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/cloud-canvas-cloud-gem-portal-log-tab-5.png)
...
![\[View log stream in the CloudWatch Logs console for your cloud gems.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/cloud-canvas-cloud-gem-portal-log-tab-6.png)
...
![\[Choose a log group from CloudWatch Groups\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/cloud-canvas-cloud-gem-portal-log-tab-7.png)

1. Click **\(Top\)** next to the name of a log group to return to the top of the log groups\.  
![\[Click Top to return to the top of the page.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/cloud-canvas-cloud-gem-portal-log-tab-8.png)