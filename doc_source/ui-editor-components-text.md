...
![\[Example that uses a Text component to add bold in the UI Editor.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/this-text-bold.png)  
**Italic** tag: <i>  

![\[Example that uses a Text component to add italics in the UI Editor.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/this-text-italic.png)  
**Font color** tag: <font color>  

![\[Example that uses a Text component to add font color in the UI Editor.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/this-text-red.png)  
**Font face** tag: <font face>  

![\[Example that uses a Text component to add different fonts in the UI Editor.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/this-text-font.png)
