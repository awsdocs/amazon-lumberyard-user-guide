...
![\[A Script Canvas graph that presigns a URL for an object in Amazon S3\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/cloud-canvas-cloud-gem-aws-s3-presign-sc-1.png)
