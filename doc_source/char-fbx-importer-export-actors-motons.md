...
+ We recommend that you enable the [EMotionFX Animation](gems-system-gem-emotionfx-animation.md) gem or the CryLegacyAnimation gem, but not both\. You can disable the animation gem that you don't use\. For more information, see [Using Gems to Add Modular Features and Assets](gems-system-gems.md)\.
...
**If you enabled the [EMotionFX Animation](gems-system-gem-emotionfx-animation.md) gem:**  
