...
### Options<a name="asset-bundler-command-line-reference-seeds-options"></a>
...
```
        Bin64vc141\AssetBundlerBatch.exe compare --comparisonType intersectionCount --firstAssetFile engine_pc.assetlist,game_pc.assetlist,patch_pc.assetlist --print
```
...
### Options<a name="asset-bundler-command-line-reference-bundlesettings-options"></a>
