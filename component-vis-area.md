...
![\[The VisArea component properties in Lumberyard Editor.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/vis-area-component-properties.png)
...
![\[The VisArea component hides one box from another.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/component-visarea.png)

**Example 2**  
In the same example, the **DisplayFilled** option is disabled in the visible area\.  

![\[Use the VisArea component to create a shape to display and hide objects.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/component-visarea-2.png)
...
![\[The VisArea component displays an ocean in the visible area.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/component-visarea-1.png)
...
![\[Legacy non-planar visible area visualization.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/component-visarea-3.png)
