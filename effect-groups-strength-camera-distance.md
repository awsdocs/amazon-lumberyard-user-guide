...
![\[Use the Apply Effect Group At Position node in the Script Canvas editor.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/scriptcanvasnodes/example-script-apply-effect-group-at-position.png)
