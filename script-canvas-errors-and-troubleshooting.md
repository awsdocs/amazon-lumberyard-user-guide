...
![\[Example that notifies users of errors in data validation\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/script-canvas-errors-and-troubleshooting-1.png)