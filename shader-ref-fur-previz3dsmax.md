...
![\[Example of using 3DSMax fur previsualization.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/shader-ref-fur-21.png)
...
![\[Example selecting the driver to visualize fur for a mesh.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/shader-ref-fur-22.png)

   1. If it does not display **Direct3D 9\.0**, click **Choose Driver**\. From the drop\-down menu, choose **Legacy Direct3D**\. Click **OK**\.  
![\[Example for displaying driver selection.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/shader-ref-fur-23.png)
...
![\[Example of selecting a material to set for the fur.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/shader-ref-fur-24.png)

1. Click in filename box\. Navigate to your Lumberyard install folder, and select `dev\Tools\maxscript\fx\Fur.fx`\.  
![\[Example of selecting the fur file name.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/shader-ref-fur-25.png)
...
![\[Select the mesh or sub-mesh material picker.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/shader-ref-fur-26.png)
...
![\[Example apply vertex colors for a mesh.\]](http://docs.aws.amazon.com/lumberyard/latest/userguide/images/shader-ref-fur-27.png)
